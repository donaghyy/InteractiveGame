...
public class Main {
	...
	public void getPlayerDetails() {
		...
		Player p1 = new Player(name, 2, 0, 0);
		chapterOneStart(p1);
	}
	
	public void requestDirection(Player p1) {
	...
	public void chapterOneStart(Player p1) {
		System.out.println("\n-- CHAPTER ONE --");
	...
	public void chapterOneMiddle(Player p1) {
		String input = "";
	...
	public void chapterOneEnd(Player p1){
		String input = "";
	...
	public void chapterTwoStart(Player p1) {
		System.out.println("\n-- CHAPTER TWO --");
	...
	public void proceedNorth(Player p1) {
	...
	public void proceedEast(Player p1) {
	...
	public void proceedSouth(Player p1) {
		p1.setyVal(p1.getyVal()-1);
	...
	public void proceedWest(Player p1) {
		p1.setxVal(p1.getxVal()-1);
